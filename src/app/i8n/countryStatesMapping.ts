export class CountryStatesMapper {
  ...
  getStatesByCountry(country) {
    ...
    switch (country.toUpperCase()) {
      case 'INDIA':
        listOfStates = ['Andhra Pradesh', 'Arunachal Pradesh', 'Assam', 'Bihar', 'Chhattisgarh', 'Goa',
         ...
         'Rajasthan', 'Sikkim', 'Tamil Nadu', 'Telagana', 'Tripura', 'Uttaranchal', 'Uttar Pradesh',
